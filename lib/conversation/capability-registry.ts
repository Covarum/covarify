...
export const capabilityRegistry: Record<CapabilityId, CapabilityDefinition> = {
  READ_FINANCIAL_STATE: define("READ_FINANCIAL_STATE", ["READ_STATE"], "READ_ONLY", "read", "decision"),
  ...
  PROPOSE_MEMORY: define("PROPOSE_MEMORY", ["PROPOSE_MEMORY"], "READ_ONLY", "memory", "proposal"), OUT_OF_SCOPE: define("OUT_OF_SCOPE", ["OUT_OF_SCOPE", "UNRESOLVED"], "READ_ONLY", "redirect", "clarification"),
};
