  ...
  return <div className="workspace-page">
    ...
    <main className="workspace-main">
      ...
      <section className="workspace-grid" id="money-picture">
        <article className="workspace-connection-card"><div className="connection-visual" aria-hidden="true"><span className="orbit-ring orbit-ring-one" /><span className="orbit-ring orbit-ring-two" /><span className="orbit-core"><LockKeyhole size={23} /></span></div><div className="connection-copy"><p className="card-kicker">Money Picture · Ready when you are</p><h2>Bring your financial life into focus.</h2><p>Your first secure account connection will begin your Money Picture—organizing balances, cash flow, and the context behind your next decision in one calm view.</p><button className="workspace-connect" type="button" disabled><span>Connect your first account</span><ArrowRight size={17} /></button><p className="workspace-gate"><LockKeyhole size={13} />Internal beta gate · Connections are not enabled yet</p></div></article>
